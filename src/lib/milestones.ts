...
export const MILESTONES: MilestoneDefinition[] = [
  ...
  },
  {
    ...
    label: "On Fire",
    emoji: "🔥",
    description: "3-day streak! You're building real momentum.",
    requirement: "Post a reflection 3 days in a row.",
    tier: "bronze",
  },
  {
    id: "streak_7",
    ...
    emoji: "⚔️",
    description: "7-day streak! A full week of consistent reflection.",
    requirement: "Post a reflection every day for 7 consecutive days.",
    tier: "silver",
  },
  {
    id: "streak_14",
  ...
  },
  {
    ...
    emoji: "💡",
    description: "10 reflections shared! Your voice is growing.",
  ...
  },
  {
    ...
    label: "Century Club",
    emoji: "🏆",
    description: "100 reflections! You are a pillar of the MindFuel community.",
